...
+ Note how some taxa cluster together in ordination space.  These taxa have similar correlations to the same factors (and, by implication, are correlated to each other).  For the taxa with high loadings in your PCA analyses, where are they plotting in these NMDS ordination plots, and are the results consistent between these two forms of ordination?
