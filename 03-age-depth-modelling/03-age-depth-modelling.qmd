...
theme:
  ...
  dark: darkly
---
## Quinn Asena & Jack Williams

# Before the lab

__Using what you learned from the last lab:__

1. Create a directory for this lab called 03-age-depth-models and two sub-directories within it called 'data', and 'outputs'
...
**Needs updating: Action point for Jack**
